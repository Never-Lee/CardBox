    ...
    <div className="groups">
      {SUITS.map((suit) => {
        ...
        const isSelectedForCurrentPlayer =
          recoveryMode && selectedRecoverySuit === suit.id;
        ...
        return (
          <div key={suit.id} className="suit-group">
            <div className="suit-table-head">
              ...
              {recoveryMode && (
                <button
                  className={`mini-card ${suit.color} ${isSelectedForCurrentPlayer ? "selected" : ""}`}
            ...
            <div className="card-row">
              {suitCards.map((card) => (
                <span
                  key={card.id}
                  className={`mini-card ${card.color} ${isSelectedForCurrentPlayer ? "selected" : ""}`}
                >
                  {cardLabel(card)}
                </span>
              ))}
