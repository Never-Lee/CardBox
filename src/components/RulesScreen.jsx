      ...
      <div className="container narrow">
        ...
        <Panel className="rules">
          ...
          <ul>
            ...
            <li>Při shodě oba hráči odhalí další kartu, dokud není určen vítěz iniciativy.</li>
            <li>Odhalené karty zůstávají v ruce.</li>
          </ul>

          <h2>5. Mulligan prvního kola</h2>
          <ul>
            <li>V prvním kole po určení iniciativy mají oba hráči možnost mulliganu.</li>
            <li>Každý hráč může odhodit libovolný počet karet z ruky.</li>
            <li>Nelze odhodit kartu nebo karty použité k určení iniciativy.</li>
            <li>Odhozené karty se zamíchají zpět do balíčku.</li>
            <li>Hráč si poté dolízne do 8 karet.</li>
            <li>Po mulliganu obou hráčů začne útočit hráč, který vyhrál iniciativu.</li>
          </ul>
          ...
          <h2>12. Recovery na konci kola</h2>
          <ul>
            <li>Jako první recoveruje hráč, který ukončil kolo třetí pauzou.</li>
            <li>Poté recoveruje druhý hráč.</li>
            <li>Každý hráč vybere jeden suit.</li>
            <li>Všechny jeho vyložené karty tohoto suitu se zamíchají zpět do jeho balíčku.</li>
